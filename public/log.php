...
<div class="container body">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form action="https://www.autofarmer.xyz/log.php">
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <input type="text" class="form-control" value="<?=isset($_REQUEST['ip']) ? $_REQUEST['ip'] : '' ?>" name="ip" placeholder="Nhập IP">
                        </div>
                        <input type="submit" value="search" class="btn btn-primary">
			             <a href="https://www.autofarmer.xyz/log/delete" class="btn btn-danger">Delete</a>
                        </form>
    ...
    <input type="hidden" id="getAtionUrl" value="https://www.autofarmer.xyz/log?ip=<?=isset($_REQUEST['ip']) ? $_REQUEST['ip'] : '' ?>&imei=<?=isset($_REQUEST['imei']) ? $_REQUEST['imei'] : '' ?>">
        <!-- footer content -->
        <footer>
    ...
    function viewData(page) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#exception').find('.page-link').attr('href', 'javascript:void(0)');
            },
