...
<div class="container body">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form action="https://www.autofarmer.xyz/exception.php">
    ...
    <input type="hidden" id="getAtionUrl" value="https://www.autofarmer.xyz/exception?ip=<?=isset($_REQUEST['ip']) ? $_REQUEST['ip'] : '' ?>">
        <!-- footer content -->
        <footer>
